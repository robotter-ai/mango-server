...
export function isLiquidationEvent(
  event: MangoEvent,
): event is LiquidationEvent {
  return event.eventType === "liquidation";
}

export function isPerpPlaceOrderEvent(
  event: MangoEvent,
): event is PerpPlaceOrderEvent {
  return event.eventType === "perpPlaceOrder";
}

export function isPerpSettlePnlEvent(
  event: MangoEvent,
): event is PerpSettlePnlEvent {
  return event.eventType === "perpSettlePnl";
}

export function isPerpSettleFeesEvent(
  event: MangoEvent,
): event is PerpSettleFeesEvent {
  return event.eventType === "perpSettleFees";
}

export function isPerpForceClosePositionEvent(
  event: MangoEvent,
): event is PerpForceClosePositionEvent {
  return event.eventType === "perpForceClosePosition";
}

export function isPerpCancelOrderEvent(
  event: MangoEvent,
): event is PerpCancelOrderEvent {
  return event.eventType === "perpCancelOrder";
}

export function isPerpCancelAllOrdersEvent(
  event: MangoEvent,
): event is PerpCancelAllOrdersEvent {
